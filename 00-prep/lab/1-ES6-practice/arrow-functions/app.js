...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sum(1, 2, 3, 4), 'this is sum arrow')

const objectLit = obLit => ({
  key1: 'value1',
  key2: 'value2',
  key3: 'value3'
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(objectLit(), 'object literal')
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(sumAndProduct(3, 9), 'sum and product')

const message = (name) => `Hello, ${name}!. This is just one line of code. It's funny we say, 'just' one, like one is a small number. Of course one is just a number, bigger or smaller in relation to our view of the number line, which is a representation of infinity. So really, one is huge, depending on your position in space and time.`
...
// const StudentWhoIsSmarterThanTheClass = (name, age, hometown) => {
//   this.name = name
//   this.age = age
//   this.hometown = hometown
// };
...
console.log((joe), 'breaks with arrow function')
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(Student.courseName(), ' And she writes functions in 1 line');
...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scope(), 'the old way');

Student.prototype.scopeArrow = () => console.log(this)

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(joe.scopeArrow(), 'dang dude, you\'re looking effecient.');

// TODO: Write a COMMENT below to answer the following questions.
// 1. What is "this" when joe.scope() is invoked?
// the new Student object that appears in the console.
// 2. What is "this" when joe.scopeArrow() is invoked?
// a "bubbled up" object attached to the Window
// 3. Explain why "this" is different when an arrow function is used.
// Because arrow functions bubble up to a higher level of scope.
