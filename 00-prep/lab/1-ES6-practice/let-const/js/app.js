...
function displayPics () {
  ...
  // with let declared only in the function displayPics(), it did not assign the ouput value of makeRandom() globally. Rather, it assigned the value only within the block. The console log occurs globally, and there is not a value to reference within that scope. 
  console.log(viewed)
